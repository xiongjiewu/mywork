		...
		if ( ! is_uploaded_file($_FILES[$field]['tmp_name']))
		{
			...
			switch($error)
			{
				case 1:	// UPLOAD_ERR_INI_SIZE
					$this->set_error('文件大小超出限制!');
					break;
				case 2: // UPLOAD_ERR_FORM_SIZE
					$this->set_error('要上传的文件大小超出浏览器限制!');
					break;
				case 3: // UPLOAD_ERR_PARTIAL
					$this->set_error('文件仅部分被上传!');
					break;
				case 4: // UPLOAD_ERR_NO_FILE
					$this->set_error('您没有选择上传的文件!');
					break;
				case 6: // UPLOAD_ERR_NO_TMP_DIR
					$this->set_error('服务器连接失败，请重新尝试!');
					break;
				...
				case 8: // UPLOAD_ERR_EXTENSION
					$this->set_error('服务器连接失败，请重新尝试!');
					break;
				default :   $this->set_error('您没有选择上传的文件!');
					break;
			}
