                    ...
                    <div class="span9">
                        <div class="bs-docs-example">
                            <div class="user_image">
                                ...
                                <form name="userphone" id="userphone" method="post" action="<?php echo rtrim(get_url(APF::get_instance()->get_config_value("image_upload_url")),"/") . "/index/{$userId}/user";?>" autocomplete="off" enctype="multipart/form-data">
