<div class="row">
    ...
    <div class="right_container">
        <div class="main-tab">
            ...
            <?php else:?>
                <a <?php if ($type =="suggest"):?>class="tab-focus"<?php endif;?> href="<?php echo get_url("/usercenter/feedback/suggest/")?>">投诉与建议</a>
            <?php endif;?>
        </div>
        <div id="usermain">
            <div class="show mod-dist-r">
                <div class="modbox2">
                    <div class="select_create">
                        ...
                        <div class="iWant">
                            <a href="<?php echo get_url("/usercenter/createfeedback/want/");?>" class="btn btn-warning">反馈我想看</a>
                        </div>
                    </div>
                        ...
                        <?php if (!empty($feedbackInfos)):?>
                            <?php foreach($feedbackInfos as $fVal):?>
                                <tr>
                                    ...
                                    <td class="action">
                                        <?php if ($fVal['reply'] == 0):?>
                                        <a href="<?php echo get_url("/usercenter/editfeedback/want/{$fVal['id']}/")?>">编辑</a>
                                        <?php else:?>
                                    ...
                                    <td class="show_eply"><?php if ($fVal['reply'] == 0):?>无回复<?php else:?><a href="<?php echo get_url("/usercenter/message/{$fVal['reply']}/");?>" title="点击查看回复">有回复</a><?php endif;?></td>
                                </tr>
                            <?php endforeach;?>
                        <?php else:?>
