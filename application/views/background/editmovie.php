<div class="upmovie">
    ...
    <div class="success">
        编辑成功![<a href="" target="_blank">访问</a>]
    </div>
    <?php endif;?>
    <form name="upmovie" id="upmovie" method="post" action="<?php echo get_url("/background/updatedy/");?>" autocomplete="off" autocomplete="off" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr class="movie_nianfen">
                <td>年&nbsp;&nbsp;&nbsp;份：</td>
                <td><input type="text" name="nianfen" id="nianfen" value="<?php echo $dyInfo['nianfen'];?>">&nbsp;年&nbsp;<code>*</code></td>
            </tr>
            <tr class="movie_diqu">
                <td>类&nbsp;&nbsp;&nbsp;型：</td>
                <td>
            ...
            <tr class="movie_time0">
                <td>本&nbsp;&nbsp;&nbsp;上：</td>
                <td><input type="text" name="time0" id="time0" value="<?php echo date("Ymd",$dyInfo['time0'])?>">&nbsp;本站能提供观看链接时间</td>
            </tr>
            <tr class="movie_time">
                <td>国&nbsp;&nbsp;&nbsp;上：</td>
                <td><input type="text" name="time1" id="time1" value="<?php echo date("Ymd",$dyInfo['time1'])?>">&nbsp;国内上映时间</td>
            </tr>
            <tr class="movie_time">
                <td>港&nbsp;&nbsp;&nbsp;上：</td>
                <td><input type="text" name="time2" id="time2" value="<?php echo date("Ymd",$dyInfo['time2'])?>">&nbsp;港台上映时间</td>
            </tr>
            <tr class="movie_time">
                <td>欧&nbsp;&nbsp;&nbsp;上：</td>
                <td><input type="text" name="time3" id="time3" value="<?php echo date("Ymd",$dyInfo['time3'])?>">&nbsp;欧美上映时间</td>
            </tr>
