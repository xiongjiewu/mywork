...
(function ($) {
    $(document).ready(function () {
        ...
        var dySortObj = $("ul li.dy_sort");
        var typeListObj = $("ul li.dy_sort div.dy_type_list");
        ...
        var topMenusObj = $("ul li.username,ul li.username div.user_in");
        topMenusObj.mouseover(function () {
            $("ul li.username div.user_in").show();
        });
