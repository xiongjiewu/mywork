<div class="bs-docs-example">
    <div class="upmovie">
        ...
        <?php elseif (!empty($success)): ?>
            <div class="success">
                上传成功![<a href="<?php echo get_url("/detail/index/{$success}"); ?>" target="_blank">访问</a>]或[<a
                    href="<?php echo get_url("background/editmovie?id={$success}"); ?>">编辑</a>]
            </div>
        <?php endif;?>
        <form name="upmovie" id="upmovie" method="post" action="<?php echo get_url("/upmovieaction/"); ?>"
              autocomplete="off" enctype="multipart/form-data">
            <input type="hidden" name="watchLink" id="watchLink" value="">
            <input type="hidden" name="return" id="return"
                   value="<?php echo get_url(get_config_value("image_upload_return")); ?>">
            <input type="hidden" name="upload_url" id="upload_url"
                   value="<?php echo get_url(get_config_value("image_upload_url")); ?>">
            ...
            <table class="table">
                ...
                <tr class="movie_nianfen">
                    <td>年&nbsp;&nbsp;&nbsp;份：</td>
                    <td>
                        <input type="text" readonly="true" class="Wdate" onclick="WdatePicker()" name="nianfen" id="nianfen">
                        &nbsp;年&nbsp;
                        <code>*</code>
                    </td>
                </tr>
                <tr class="movie_diqu">
                    ...
                    <td>
                        <select name="type">
                            <?php foreach($movieType as $key => $val):?>
                ...
                <tr class="movie_diqu">
                    ...
                    <td>
                        <select name="diqu">
                            <?php foreach($moviePlace as $pKey=>$pval):?>
                                <option value="<?php echo $pKey;?>"><?php echo $pval;?></option>
                            <?php endforeach;?>
                        </select>&nbsp;<code>*</code>
                    </td>
                </tr>
                ...
                <tr class="movie_time0">
                    <td>本&nbsp;&nbsp;&nbsp;上：</td>
                    <td><input type="text" name="time0" id="time0" class="Wdate" readonly="true" onclick="WdatePicker()">&nbsp;本站能提供观看链接时间</td>
                </tr>
                <tr class="movie_time">
                    <td>国&nbsp;&nbsp;&nbsp;上：</td>
                    <td><input type="text" name="time1" id="time1" class="Wdate" readonly="true" onclick="WdatePicker()">&nbsp;国内上映时间</td>
                </tr>
                <tr class="movie_time">
                    <td>港&nbsp;&nbsp;&nbsp;上：</td>
                    <td><input type="text" name="time2" id="time2" class="Wdate" readonly="true" onclick="WdatePicker()">&nbsp;港台上映时间</td>
                </tr>
                <tr class="movie_time">
                    <td>欧&nbsp;&nbsp;&nbsp;上：</td>
                    <td><input type="text" name="time3" id="time3" class="Wdate" readonly="true" onclick="WdatePicker()">&nbsp;欧美上映时间</td>
                </tr>
                ...
                <tr class="movie_link">
                    ...
                    <td class="downloadLink">
                        <em>
                            <input type="text" class="link">&nbsp;大小：<input type="text" class="size"
                                                                            style="width: 60px">&nbsp;M
                            &nbsp;<select class="type">
