...
class MY_Controller extends CI_Controller
{
        ...
        if (!empty($this->adminId)) {
            ...
            if (!empty($this->userId) && isset($this->userName)) {
                ...
                if (!empty($adminInfo)) {
                    ...
                    $this->setLoginCookie($this->userName,$this->userId,$adminInfo['id'],86400,0);
    ...
    public function initArrById($arr = array(), $type = "infoId",&$ids = array())
    {
        if (empty($arr)) {
            return $arr;
        }
    ...
    public function setLoginCookie($username, $userid,$adminId, $time = 0, $remember = 0)
    {
